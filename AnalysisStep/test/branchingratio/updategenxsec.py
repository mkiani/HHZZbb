...
def rawgenxsec(identifier, year):
  with contextlib.closing(urllib.urlopen("https://raw.githubusercontent.com/CJLST/HHZZbb/6dc3fc8aa7dccd1952645c9aac8320d20b6e8137/AnalysisStep/test/prod/samples_{}_MC.csv".format(year))) as f:
